    ...
    <div class="row">
        ...
        <div class="main-content contentContainer">
            <div class="contentArea contentPadding">
                ...
                <h3 class="toggle solid-border section-title-large">Låner jeg et stykke værktøj?</h3>
                <div class="toggle-content" style="">
                ...
                <h3 class="toggle solid-border section-title-large">Afleverer jeg et stykke værktøj?</h3>
                <div class="toggle-content" style="">
                ...
                <h3 class="toggle solid-border section-title-large">Hvad bruges kommentar-feltet til?</h3>
                <div class="toggle-content" style="">
                ...
                <h3 class="toggle solid-border section-title-large">Hvorfor fik jeg en bøde?</h3>
                <div class="toggle-content" style="">
                ...
                <h3 class="toggle solid-border section-title-large">Hvorfor kan jeg ikke reservere flere stykker værktøj?</h3>
                <div class="toggle-content" style="">
                ...
                <h3 class="toggle solid-border section-title-large">Hvor blev min reservation af?</h3>
                <div class="toggle-content" style="">
                ...
                <h3 class="toggle solid-border section-title-large">Hvorfor har I ikke værktøjet x og y??</h3>
                <div class="toggle-content" style="">
                ...
                <h3 class="toggle solid-border section-title-large">Hvad skal jeg gøre hvis jeg oplever en fejl på siden?</h3>
                <div class="toggle-content" style="">
                ...
                <h3 class="toggle solid-border section-title-large">Hvor kan jeg låne værktøj?</h3>
                <div class="toggle-content" style="">
                    <p>Du kan låne værktøj i et af Initechs fysiske varehuse.</p> 
                </div>

                <h3 class="toggle solid-border section-title-large">Hvor kan jeg aflevere værktøj?</h3>
                <div class="toggle-content" style="">
